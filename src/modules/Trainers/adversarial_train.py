...
class AdversarialTrainer:
    def __init__(self, generator: Generator, discriminator: Discriminator) -> None:
        ...
        save_images = bool(adv_config['save_images'])
        if save_images:
            ...
            for i, (imgs_lr, imgs_hr) in enumerate(train_loader):
                try:
                    ...
                    for index in range(self.g_steps):
                        ...
                        print_progress(epoch, self.num_epochs, i,
                                       100, (d_loss.item(), g_total_loss.item()), adversarial_loss=True)
                    ...
                    break
            save_image(
                gen_hr.data, f'images/gen_hr_epoch_{epoch}.png', normalize=True)
